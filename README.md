...
<br><br>
<b>QGIS:</b><br>
QGIS is open-source cross-platform and free Geographic Information System(GIS) application. This software allows for the analysis and editing of geospatial data, and provides the ability to compose and export graphical maps. QGIS supports both raster and vector layers, allowing for drawing points and polygonal features. It also supports a wide variety of raster image formats and it can manage georeferenced images. The software can, as with conventional GIS programs, combine geophysical data with map and satellite data. With the addition of local geophysical data retrieved from Greenland, added on top of Sentinel satellite images and possibly Digital Elevation Maps(DEM); It could be a powerful tool for combining all the data in 1 comprehensible visual product. It is also possible to connect it to python through plugins.<br><br>
<b>Testing:</b><br>
